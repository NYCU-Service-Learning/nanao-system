  ...
  return (
    ...
    >
      ...
      <Form>
        ...
        <Form.Item label="過去一年有無疼痛？">
          ...
          <div style={{ textAlign: "right" }}>
            <Typography.Link onClick={() => setInfoOpen(true)}>
              疼痛分級說明
            </Typography.Link>
          </div>
        </Form.Item>
      ...
      >
        <ul>
          <li>
            <strong>0-1 分</strong>：沒有疼痛
          </li>
          <li>
            <strong>2-3 分</strong>：輕微疼痛
          </li>
          <li>
            <strong>4-5 分</strong>：疼痛不舒服
          </li>
          <li>
            <strong>6-7 分</strong>：疼痛很困擾
          </li>
          <li>
            <strong>8-9 分</strong>：疼痛很嚴重
          </li>
          <li>
            <strong>10 分</strong> ：最痛
          </li>
        </ul>
      </Modal>
    </Modal>
